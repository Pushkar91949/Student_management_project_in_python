...
###############################################
##mydb=mysql.connector.connect(host="localhost",user="your_user_here",passwd="your_passwd_here")
##cursor=mydb.cursor()
##cursor.execute("create database psj_students")
##cursor.close()
##mydb=mysql.connector.connect(host="localhost",user="your_user_here",passwd="your_passwd_here",database="psj_students")
##cursor=mydb.cursor()
...
while opt!=12:
    ...
    while opt==2:  #IF OPTION SELECTED IS 2, ALL THE STUDENTS DETAILS SAVED IN THE SYSTEM WIL BE SHOWN ONE BY ONE
        mydb=mysql.connector.connect(host="localhost",user="your_user_here",passwd="your_passwd_here",database="psj_students")   #MAKING DATABASE CONNECTION
        cursor=mydb.cursor()
